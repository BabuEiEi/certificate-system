...
- ข้อมูลบังคับมีเพียง `ชื่อ-นามสกุล`; อีเมล หน่วยงาน และรหัสผู้รับเป็นข้อมูลเพิ่มเติมที่ไม่บังคับ
- `ประเภท` เป็นข้อมูลไม่บังคับ โดยเลือก `ผ่านการอบรม` หรือ `เข้าร่วม` เมื่อใช้ Template เดียวกับผู้รับหลายประเภท และเว้นว่างได้เมื่อแยก Template ตามประเภท
...
- Excel Template ใช้เพียง `ชื่อ-นามสกุล` และ `ประเภท`; ระบบยังรองรับอีเมล หน่วยงาน รหัสผู้รับ และสถานะเป็นคอลัมน์เสริม
